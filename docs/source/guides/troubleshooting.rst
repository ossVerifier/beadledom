...
Multibinder with PrivateModule issue
""""""""""""""""""""""""""""""""""""

Problem
  Guice does not support using a multibinder for the same type across multiple PrivateModules or between a PrivateModule and AbstractModule.

Solution
  Make sure any usage of multibinders, including in your installed dependencies, are not used across different types of Guice modules.
